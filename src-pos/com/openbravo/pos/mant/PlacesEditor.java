...
public class PlacesEditor extends JPanel implements EditorRecord {
    ...
    private void initComponents() {
        ...
        add(jLabel2);
        jLabel2.setBounds(250, 20, 90, 15);
        add(m_jName);
        m_jName.setBounds(50, 20, 180, 19);

        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel3.setText(AppLocal.getIntString("label.placeposition")); // NOI18N
        add(jLabel3);
        jLabel3.setBounds(240, 80, 90, 15);
        add(m_jX);
        m_jX.setBounds(180, 80, 50, 19);
        add(m_jY);
        m_jY.setBounds(110, 80, 50, 19);

        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel1.setText(AppLocal.getIntString("label.placefloor")); // NOI18N
        add(jLabel1);
        jLabel1.setBounds(250, 50, 90, 15);
        add(m_jFloor);
        m_jFloor.setBounds(60, 50, 170, 20);
